/*
  ...
  2. Use no Wix a URL:
     https://cdn.jsdelivr.net/gh/AcepeConstrucoes/head-site-acepe/head-site-acepe.js
  3. Adicione um Elemento Personalizado / Custom Element.
  4. URL do servidor: cole a URL acima.
  5. Nome da tag: acepe-hero

  URLs dos botões:
  - Troque PRIMARY_BUTTON_URL pelo link do orçamento/WhatsApp.
  - Troque SECONDARY_BUTTON_URL pelo link da seção/página de obras.
*/
...
if (typeof window !== "undefined" && window.customElements && !window.customElements.get("acepe-hero")) {
